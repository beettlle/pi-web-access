# Task: SP-010 — Update gemini-search error messages
...
```
spine-tasks/SP-010-gemini-search-parallel-errors/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Update no-provider error messages to mention parallelApiKey and PARALLEL_API_KEY.
...
- [ ] Update final no search provider available message

### Step 2: Implementation

- [ ] Verify auto failure message lists Parallel when relevant
...
- `feat(SP-010): complete Step N — description`
- `fix(SP-010): description`
- `test(SP-010): description`

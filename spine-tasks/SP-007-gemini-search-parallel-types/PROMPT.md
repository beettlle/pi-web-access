# Task: SP-007 — Add parallel to gemini-search types
...
```
spine-tasks/SP-007-gemini-search-parallel-types/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Extend SearchProvider types and normalizeSearchProvider for parallel; add imports.
...
- [ ] Extend normalizeSearchProvider() to accept parallel

### Step 3: Implementation

- [ ] Import isParallelAvailable and searchWithParallel
...
- `feat(SP-007): complete Step N — description`
- `fix(SP-007): description`
- `test(SP-007): description`

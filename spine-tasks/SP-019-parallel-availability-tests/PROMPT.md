# Task: SP-019 — Parallel availability tests
...
```
spine-tasks/SP-019-parallel-availability-tests/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Test isParallelAvailable without key, with config key, with env key.
...
- [ ] Test false with empty HOME

### Step 2: Implementation

- [ ] Test true with parallelApiKey in web-search.json

### Step 3: Implementation

- [ ] Test true with PARALLEL_API_KEY env
...
- `feat(SP-019): complete Step N — description`
- `fix(SP-019): description`
- `test(SP-019): description`

# Task: SP-021 — Parallel extract mapper tests
...
```
spine-tasks/SP-021-parallel-extract-mapper-tests/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Mock /v1/extract for full_content, excerpts, short content, errors.
...
- [ ] Test full_content mapping

### Step 2: Implementation

- [ ] Test excerpts-only mapping

### Step 3: Implementation

- [ ] Test short content returns null and errors[] returns null
...
- `feat(SP-021): complete Step N — description`
- `fix(SP-021): description`
- `test(SP-021): description`

# Task: SP-012 — index getProviderAvailability parallel
...
```
spine-tasks/SP-012-index-get-provider-availability/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Add parallel: isParallelAvailable() to getProviderAvailability().

## Dependencies

- **Task:** SP (index parallel availability type)
...
- [ ] Update getProviderAvailability return object
...
- `feat(SP-012): complete Step N — description`
- `fix(SP-012): description`
- `test(SP-012): description`

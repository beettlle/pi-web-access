# Task: SP-014 — index resolveProvider auto-order and fallbacks
...
```
spine-tasks/SP-014-index-resolve-provider-parallel/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Update resolveProvider() for exa→parallel→perplexity→gemini auto order and unavailable fallbacks.

## Dependencies

- **Task:** SP (index get provider availability)
...
- [ ] Insert parallel in auto default order after exa

### Step 2: Implementation

- [ ] Add parallel unavailable-provider fallback branches

### Step 3: Implementation

- [ ] Mirror existing exa/perplexity/gemini fallback patterns
...
- `feat(SP-014): complete Step N — description`
- `fix(SP-014): description`
- `test(SP-014): description`

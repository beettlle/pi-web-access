# Task: SP-011 — index ProviderAvailability parallel field
...
```
spine-tasks/SP-011-index-parallel-availability-type/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Add parallel to ProviderAvailability interface and import isParallelAvailable.
...
- [ ] Extend ProviderAvailability with parallel: boolean
...
- `feat(SP-011): complete Step N — description`
- `fix(SP-011): description`
- `test(SP-011): description`
